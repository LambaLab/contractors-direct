  ...
  return (
    <section className="py-24 px-4 border-t border-white/5">
      <div className="max-w-5xl mx-auto">
        <h2 className="font-heading font-bold text-5xl md:text-6xl text-center text-brand-white mb-4">
          EXAMPLE PROJECTS
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {EXAMPLES.map((ex) => (
            <div key={ex.label} className="p-6 rounded-2xl bg-white/5 border border-white/5">
              ...
              <p className="font-heading font-bold text-3xl text-brand-purple">{ex.range}</p>
            </div>
          ))}
        </div>
      </div>
